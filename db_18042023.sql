...
MySQL - 8.0.32 : Database - db_academico
*********************************************************************
*/
...
CREATE TABLE `tbl_estudiantes` (
  ...
  `fld_ciures` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `fld_telfijo` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
CREATE TABLE `tbl_materias` (
  ...
  `fld_nombre` varchar(30) DEFAULT NULL,
  `fld_programa` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `fld_tipo_materia` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `fld_consecutivo` int NOT NULL AUTO_INCREMENT,
  KEY `fld_consecutivo` (`fld_consecutivo`)
...
CREATE TABLE `tbl_notas` (
  `fld_codestu` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `fld_nomest` varchar(30) DEFAULT NULL,
  `fld_apeest` varchar(30) DEFAULT NULL,
  `fld_materia` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
CREATE TABLE `tbl_profesores` (
  `fld_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `fld_nombre` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `fld_apellido` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `fld_direccion` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `fld_celular` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `fld_fecnac` date DEFAULT NULL,
  `fld_email` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `fld_ciures` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `fld_profesion` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `fld_experiencia` int DEFAULT NULL,
  `fld_genero` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `fld_consecutivo` int NOT NULL AUTO_INCREMENT,
  KEY `fld_consecutivo` (`fld_consecutivo`)
...
CREATE TABLE `tbl_usuarios` (
  `fld_usuario` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,

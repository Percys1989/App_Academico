...
<html lang="es">
    <head>
        ...
        <title>Scholl Manager - Programas Academicos</title>
    </head>
    <body>
        <div class="container-fluid">
            <header>
                <nav class="nav nav-pills nav-fill">
                    ...
                    <a class="nav-link active disabled fw-bolder" aria-current="page" tabindex="-1" aria-disabled="true">Prg. Academicos</a>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card text-center gap-3">
                            ...
                            <button type="button" id='btnAgregar' class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalAgregar"><i class="bi bi-person-add p-1"></i> Agregar Programa</button>
                                <h4>Datos de los Programas Academicos</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <!--tabla Prg Academico-->
                                    <table class="table table-hover" id="tblPrgacademico">
                                        <thead class="table table-dark">
                                            <tr>
                                                <th scope="col">Cod_Programa</th>
        ...
        <script src="../js/frmprgacademicos.js"></script>
    </body>
</html>
<!-- Modal Agregar -->
  ...
  <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Datos de los Programas</h5>
